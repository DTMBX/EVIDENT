...
from legal_library import LegalLibraryService, CitationParser
import json
...
class ChatGPTLegalLibraryIntegration:
    ...
    def search_library_for_context(self, user_message: str, user_id: int = None) -> List[Dict]:
        ...
        results = self.library.search_library(
            ...
            limit=5  # Top 5 most relevant cases
        )
    ...
    def _extract_legal_keywords(self, text: str) -> List[str]:
        ...
        # Common legal terms
        legal_terms = [
            'amendment', 'constitutional', 'supreme court', 'circuit',
            'search', 'seizure', 'warrant', 'probable cause',
            'miranda', 'rights', 'due process', 'equal protection',
            'excessive force', 'qualified immunity', 'section 1983',
            'brady', 'giglio', 'discovery', 'evidence',
            'counsel', 'trial', 'appeal', 'habeas',
