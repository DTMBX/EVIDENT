...
from models_auth import TierLevel, User, UsageTracking, db
...
class TestTierConfiguration:
    ...
    def test_starter_tier_limits(self, app, db_session):
        ...
        with app.app_context():
            ...
            assert limits['overage_allowed'] is False, "STARTER should NOT allow overages (HARD CAP)"
    ...
    def test_premium_tier_limits(self, app, db_session):
        ...
        with app.app_context():
            ...
            assert limits['overage_fee_per_video'] == 2.00, "PREMIUM overage should be $2.00/video (higher than PRO)"
            assert limits['overage_fee_per_pdf'] == 1.00, "PREMIUM overage should be $1.00/PDF (higher than PRO)"
    ...
    def test_enterprise_tier_unlimited(self, app, db_session):
        ...
        with app.app_context():
            ...
            assert limits['overage_allowed'] is False, "ENTERPRISE should not need overages (unlimited)"
...
class TestTierComparison:
    ...
    def test_overage_fee_progression(self, app, db_session):
        ...
        with app.app_context():
            ...
            assert pro_limits['overage_fee_per_video'] < premium_limits['overage_fee_per_video'], \
                "PRO overage should be cheaper than PREMIUM to support growth"
            assert pro_limits['overage_fee_per_pdf'] < premium_limits['overage_fee_per_pdf'], \
    ...
    def test_trial_duration_by_tier(self, app, db_session):
        ...
        with app.app_context():
            ...
            assert starter_limits.get('trial_days') == 7, \
                "STARTER should have 7-day trial"
            
            # PRO gets shorter trial (3 days) for faster decision
            assert pro_limits.get('trial_days') == 3, \
                "PROFESSIONAL should have 3-day trial"
