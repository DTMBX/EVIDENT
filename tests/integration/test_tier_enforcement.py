...
def users(app):
    ...
    with app.app_context():
        ...
        for tier in [TierLevel.FREE, TierLevel.STARTER, TierLevel.PROFESSIONAL, 
                     TierLevel.PREMIUM, TierLevel.ENTERPRISE]:
            user = User(
                email=f'{tier.name.lower()}@test.com',
                tier=tier,
                is_active=True
            )
...
class TestTierUpgradeIncentives:
    ...
    def test_starter_to_pro_upgrade_incentive(self, app, users):
        ...
        with app.app_context():
            ...
            capacity_mult = pro_limits['bwc_videos_per_month'] / starter_limits['bwc_videos_per_month']
    ...
    def test_overage_cost_vs_upgrade_cost(self, app, users):
        ...
        with app.app_context():
            ...
            overage_count = 25
            overage_cost = overage_count * pro_limits['overage_fee_per_video']  # 25 × $1.50 = $37.50
