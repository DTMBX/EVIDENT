...
class UnifiedEvidenceProcessor:
    ...
    def _load_services(self):
        ...
        try:
            ...
            self.logger.info("✓ Transcription service loaded")
        except ImportError:
        ...
        try:
            ...
            self.logger.info("✓ OCR service loaded")
        except ImportError:
        ...
        try:
            ...
            self.logger.info("✓ Violation scanner loaded")
        except ImportError:
        ...
        try:
            ...
            self.logger.info("✓ Compliance checker loaded")
        except ImportError:
    ...
    def process_evidence(self, evidence_file: Path, evidence_type: str, 
    ...
    def _check_compliance(self, file_path: Path, evidence_type: str, 
    ...
    def _generate_summary(self, results: Dict) -> str:
        ...
        if compliance:
            ...
            if status == "NON_COMPLIANT":
                summary_parts.append("Evidence has compliance issues that may affect admissibility.")
        ...
        return " ".join(summary_parts) if summary_parts else "Analysis complete. No critical issues detected."
