...
class SmartTools:
    ...
    LEGAL_KNOWLEDGE = {
        ...
        "jaywalking": {
            ...
            "elements": ["Crossing street illegally", "Outside crosswalk or against signal", "Pedestrian violation"],
        ...
        "probable cause": {
            ...
            "elements": ["Reasonable belief", "Based on facts and circumstances", "Would lead prudent person to believe"],
        ...
        "miranda rights": {
            ...
            "elements": ["Right to remain silent", "Anything said can be used against you", "Right to attorney", "Attorney provided if cannot afford one"],
        ...
        "double jeopardy": {
            ...
            "protections": ["Second prosecution after acquittal", "Second prosecution after conviction", "Multiple punishments for same offense"],
        ...
        "arraignment": {
            ...
            "purposes": ["Inform defendant of charges", "Enter plea", "Set bail", "Appoint counsel if needed"],
            "source": "Criminal procedure"
        },
        "indictment": {
        ...
        "hearsay": {
            ...
            "exceptions": ["Excited utterance", "Present sense impression", "Business records", "Dying declaration"],
            "source": "Evidence law"
        },
        "mens rea": {
        ...
        "first amendment": {
            ...
            "protections": ["Freedom of speech", "Freedom of religion", "Freedom of press", "Freedom of assembly", "Right to petition"],
        ...
        "fourth amendment": {
            ...
            "protections": ["Privacy in persons, houses, papers, effects", "Warrant requirement", "Probable cause"],
        ...
        "fifth amendment": {
            ...
            "protections": ["Self-incrimination privilege", "Double jeopardy", "Due process", "Grand jury requirement", "Just compensation"],
            "source": "U.S. Constitution"
        },
        "sixth amendment": {
            ...
            "rights": ["Speedy trial", "Public trial", "Impartial jury", "Know charges", "Confront witnesses", "Compel witnesses", "Counsel"],
            "source": "U.S. Constitution"
        },
        ...
        "warrant": {
            ...
            "exceptions": ["Consent", "Plain view", "Exigent circumstances", "Search incident to arrest"],
        ...
        "discovery": {
            ...
            "methods": ["Interrogatories", "Depositions", "Requests for production", "Requests for admission"],
        ...
        "felony": {
            ...
            "consequences": ["Prison time", "Fines", "Loss of voting rights", "Firearm restrictions"],
            "source": "Criminal law"
        },
        "misdemeanor": {
            ...
            "examples": ["Simple assault", "Petty theft", "DUI (first offense)", "Disorderly conduct"],
        ...
        "jurisdiction": {
            ...
            "types": ["Subject matter jurisdiction", "Personal jurisdiction", "Territorial jurisdiction"],
        ...
        "contempt of court": {
            ...
            "types": ["Civil contempt", "Criminal contempt", "Direct contempt", "Indirect contempt"],
        ...
        "injunction": {
            ...
            "types": ["Temporary restraining order (TRO)", "Preliminary injunction", "Permanent injunction"],
        ...
        "verdict": {
            ...
            "types": ["Guilty/Not guilty (criminal)", "Liable/Not liable (civil)", "General verdict", "Special verdict"],
    ...
    def _extract_math_expression(self, query: str) -> Optional[str]:
        ...
        cleaned = re.sub(
            r'^(what is|calculate|compute|solve|evaluate|find)\s*',
            '',
            query.lower()
        )
    ...
    def web_search(self, query: str, max_results: int = 5) -> ToolResult:
        ...
        try:
            ...
            req = urllib.request.Request(
                url,
                headers={'User-Agent': 'BarberX Legal Assistant/1.0'}
            )
    ...
    def wikipedia_search(self, query: str) -> ToolResult:
        ...
        try:
            # Extract search term
            search_term = re.sub(
                r'^(who is|what is|tell me about|define)\s*',
                '',
                query,
                flags=re.IGNORECASE
            ).strip()
    ...
    def datetime_calc(self, query: str) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                ...
                success=False,
                data=None,
                error="Could not parse date/time query"
            )
