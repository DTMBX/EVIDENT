...
class EnhancedChatAssistant:
    ...
    def record_exchange(self, user_message: Dict[str, Any], assistant_message: Dict[str, Any]) -> None:
        """
    ...
    def search_conversation_history(
        ...
        for i, msg in enumerate(self.message_history):
            ...
            if query.lower() in msg["content"].lower():
                ...
                context_after = self.message_history[i+1] if i < len(self.message_history)-1 else None
    ...
    def generate_audio_summary(
        ...
        text = re.sub(
            r'\[Doc-(\d+)-Page-(\d+)\]',
            r'as referenced in document \1, page \2,',
            text
        )
