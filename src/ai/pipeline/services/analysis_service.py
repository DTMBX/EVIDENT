...
class AnalysisService:
    ...
    def _generate_local_response(
        ...
        # Introduction
        response_parts.append(f"Based on the documents in your library, here's what I found regarding your question about \"{query}\":\n")
        ...
        response_parts.append("For more detailed analysis, consider uploading additional relevant documents or using the Pro features with your own OpenAI API key.*")
