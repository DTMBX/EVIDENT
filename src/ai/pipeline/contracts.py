...
class ManifestRecord:
    ...
    # Processed artifacts
    processed: Dict[str, any] = field(default_factory=dict)  # {repaired_pdf, ocr_pdf, page_text: [...]}
    
    # Extraction metadata
    extraction: Dict[str, any] = field(default_factory=dict)  # {method, text_layer_detected, ocr_triggered}
    
    # Timestamps
    timestamps: Dict[str, str] = field(default_factory=dict)  # {ingested_at, extracted_at, indexed_at}
