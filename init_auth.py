...
from models_auth import ApiKey, TierLevel, UsageTracking, User, bcrypt, db
...
def init_database():
    ...
    with app.app_context():
        ...
        admin_email = os.getenv("ADMIN_EMAIL", "admin@barberx.info")
...
def test_authentication():
    ...
    with app.app_context():
        ...
        if admin:
            ...
            storage = (
                "Unlimited" if limits.get("storage_gb") == -1 else f"{limits.get('storage_gb')}GB"
            )
...
if __name__ == "__main__":
    ...
    print(f\"     Email: {os.getenv('ADMIN_EMAIL', 'admin@barberx.info')}\")
