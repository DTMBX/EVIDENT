...
1. **Organization Schema**
   ```json
   {
     ...
     "foundingDate": "2025",
     "sameAs": ["https://twitter.com/barberx", "https://linkedin.com/company/barberx"]
   }
   ```
...
```json
{
  ...
  "icons": [
    ...
    { "src": "/assets/images/icon-152.png", "sizes": "152x152", "type": "image/png" },
    { "src": "/assets/images/icon-192.png", "sizes": "192x192", "type": "image/png" },
    { "src": "/assets/images/icon-384.png", "sizes": "384x384", "type": "image/png" },
