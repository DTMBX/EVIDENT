# BarberX.info - Netlify + Render Deployment Guide
...
- Sign up with GitHub
- Authorize access to DTB396/BarberX.info

#### 3. Create Web Service
1. Click **"New +"** ? **"Web Service"**
2. Connect **DTB396/BarberX.info**
3. Settings:
   - **Name:** `barberx-backend`
...
CORS_ORIGINS=https://barberx.netlify.app,https://barberx.info
MAX_CONTENT_LENGTH=5368709120
```

5. Click **"Create Web Service"**

**Your backend will be at:** `https://barberx-backend.onrender.com`
...
3. Connect GitHub ? Select `DTB396/BarberX.info`
4. Settings:
   - **Build command:** `echo "Static site"`
   - **Publish directory:** `static_site`
   - **Deploy!**

**Your frontend will be at:** `https://barberx.netlify.app`
...
```
User visits: https://barberx.netlify.app
     ?
Netlify serves: HTML/CSS/JS (static files)
     ?
JavaScript makes API calls to: https://barberx-backend.onrender.com
     ?
...
# 3. Done! Your URLs:
# Frontend: https://barberx.netlify.app
# Backend: https://barberx-backend.onrender.com
```
...
FLASK_ENV=production
CORS_ORIGINS=https://barberx.netlify.app
...
### Netlify (Frontend):
```
REACT_APP_API_URL=https://barberx-backend.onrender.com
```
...
1. **Netlify:** Point `www.barberx.info` to Netlify
2. **Render:** Point `api.barberx.info` to Render backend

Then update CORS:
```
CORS_ORIGINS=https://www.barberx.info,https://api.barberx.info
```
